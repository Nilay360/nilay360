...
> = {
  "For Buyers": [
    {
      icon: "M3 12l9-9 9 9M5 10v10h5v-6h4v6h5V10M9 21H3",
      label: "Home Loan",
      href: "/calculator",
    },
    {
    ...
    {
      icon: "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 7h16a1 1 0 010 2H4a1 1 0 010-2zm2 4h12v6a1 1 0 01-1 1H7a1 1 0 01-1-1v-6z",
      label: "EMI Calculator",
      href: "/calculator",
    },
    {
      icon: "M3 6l3 1m0 0l-3 9a5 5 0 006.9 3.9L12 21l2.1-1.1A5 5 0 0021 16l-3-9m-3 1L12 3m0 0l-3 5m3-5l3 5",
...
const MARKET: Record<
  string,
  {
    price: string;
    growth: string;
    localities: { name: string; demand: string }[];
    newListings: number;
    trend: number[];
  }
> = {
  Hyderabad: {
    ...
    growth: "+14.2%",
    localities: [
      { name: "Kokapet", demand: "Very High" },
      { name: "Gachibowli", demand: "High" },
      { name: "Kondapur", demand: "High" },
      { name: "Manikonda", demand: "Medium" },
      { name: "Nallagandla", demand: "Medium" },
    ],
    newListings: 342,
    trend: [5800, 6100, 6400, 6900, 7200],
  },
  Mumbai: {
    price: "₹28,400",
    growth: "+8.6%",
    localities: [
      { name: "Bandra West", demand: "Very High" },
      { name: "Powai", demand: "High" },
      { name: "Andheri West", demand: "High" },
      { name: "Juhu", demand: "Medium" },
      { name: "Borivali", demand: "Medium" },
    ],
    newListings: 510,
    trend: [24000, 25200, 26100, 27400, 28400],
  },
  Bengaluru: {
    price: "₹9,100",
    growth: "+12.1%",
    localities: [
      { name: "Whitefield", demand: "Very High" },
      { name: "Sarjapur", demand: "High" },
      { name: "Hebbal", demand: "High" },
      { name: "Electronic City", demand: "Medium" },
      { name: "Koramangala", demand: "Medium" },
    ],
    newListings: 418,
    trend: [7200, 7700, 8100, 8600, 9100],
  },
  "Delhi NCR": {
    price: "₹12,300",
    growth: "+9.4%",
    localities: [
      { name: "Golf Course Rd", demand: "Very High" },
      { name: "Sector 143", demand: "High" },
      { name: "Dwarka Exp.", demand: "High" },
      { name: "Greater Noida", demand: "Medium" },
      { name: "Indirapuram", demand: "Medium" },
    ],
    newListings: 389,
    trend: [10100, 10700, 11200, 11800, 12300],
  },
  Chennai: {
    price: "₹8,600",
    growth: "+10.7%",
    localities: [
      { name: "OMR", demand: "Very High" },
      { name: "Perumbakkam", demand: "High" },
      { name: "Sholinganallur", demand: "High" },
      { name: "Anna Nagar", demand: "Medium" },
      { name: "Velachery", demand: "Medium" },
    ],
    newListings: 267,
    trend: [7000, 7300, 7700, 8100, 8600],
  },
  Pune: {
    price: "₹10,200",
    growth: "+11.3%",
    localities: [
      { name: "Kharadi", demand: "Very High" },
      { name: "Wakad", demand: "High" },
      { name: "Hinjewadi", demand: "High" },
      { name: "Baner", demand: "Medium" },
      { name: "Pimpri", demand: "Medium" },
    ],
    newListings: 305,
    trend: [8100, 8600, 9100, 9700, 10200],
  },
};
...
const CATEGORY_TILES: { type: string; matchTypes: string[]; grad: string; img: string; d: string }[] = [
  { type: "Apartments",   matchTypes: ["apartment"],      grad: "linear-gradient(135deg, rgba(43,168,224,0.6) 0%, rgba(11,13,16,0.8) 100%)", img: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=60&fm=avif", d: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-2 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
...
const LOCATIONS = [
  {
    ...
    listings: 124,
    avg: "₹6,800/sqft",
    grad: "linear-gradient(135deg,#000000,#0B0D10)",
    img: "https://images.unsplash.com/photo-1590577976322-3d2d6e2130d5?w=800&q=80",
  },
  {
    city: "Mumbai",
    area: "Bandra West",
    listings: 89,
    avg: "₹42,000/sqft",
    grad: "linear-gradient(135deg,#0d1f3c,#1a3a6e)",
  ...
  },
  {
    ...
    listings: 156,
    avg: "₹8,200/sqft",
    grad: "linear-gradient(135deg,#1a1040,#3020a0)",
  ...
  },
  {
    ...
    listings: 72,
    avg: "₹18,500/sqft",
    grad: "linear-gradient(135deg,#2c1810,#5a3020)",
  ...
  },
  {
    ...
    listings: 103,
    avg: "₹9,400/sqft",
    grad: "linear-gradient(135deg,#101a10,#204020)",
  ...
  },
  {
    ...
    listings: 91,
    avg: "₹7,600/sqft",
    grad: "linear-gradient(135deg,#201010,#401a1a)",
  ...
  return (
    <span>
      {Array.from({ length: 5 }).map((_, i) => (
        <span key={i} style={{ color: i < n ? G.gold : "#444", fontSize: 13 }}>
          ★
        </span>
      ))}
    </span>
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const handler = (e: MouseEvent) => {
      if (
        cityDropRef.current &&
        !cityDropRef.current.contains(e.target as Node)
      )
        setCityOpen(false);
    };
  ...
  const startVoiceSearch = () => {
    ...
    recognition.onresult = (event: any) => {
      ...
      if (finalTranscript) {
        setTimeout(() => {
          router.push(
            `/search?q=${encodeURIComponent(finalTranscript.trim())}&city=${encodeURIComponent(searchCity)}&tab=${searchTab.toLowerCase().replace(/ /g, "-")}`,
          );
        }, 600);
      }
    };
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Nilay 360 is a technology-powered real estate platform offering property discovery, 360-degree virtual tours, and end-to-end transaction support across India.",
            address: {
              "@type": "PostalAddress",
      ...
      <section ref={heroRef} className="hero-section" style={{
        ...
        <div aria-hidden style={{position:"absolute", inset:0, overflow:"hidden", zIndex:0}}>
          ...
          <div style={{position:"absolute", inset:0, background:"linear-gradient(180deg, rgba(0,0,0,0.30) 0%, rgba(0,0,0,0.45) 40%, rgba(0,0,0,0.78) 100%), radial-gradient(ellipse 65% 50% at 50% 32%, rgba(0,0,0,0.18) 0%, transparent 70%)"}} />
        </div>
        ...
        <div
          style={{
            ...
            zIndex: 0,
            backgroundImage:
              "url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=40')",
        ...
        >
          ...
          {/* 3 — Subline */}
          <p className="hero-subline" style={{fontSize:15, color:"rgba(255,255,255,0.5)", lineHeight:1.75, marginBottom:0, fontWeight:300, margin:"0 auto", padding:"0 8px", maxWidth:"100%", boxSizing:"border-box"}}>
            {siteContent.hero_subtitle}
          </p>

          {/* 4 — Stats strip */}
          <div className="hero-stats" style={{display:"flex", flexWrap:"wrap", justifyContent:"center", gap:"12px", width:"100%", maxWidth:"100%", boxSizing:"border-box", marginTop:32, marginBottom:40, paddingBottom:32, borderBottom:"1px solid rgba(43,168,224,0.12)", position:"relative", zIndex:2}}>
            {[[liveStats.listings.toLocaleString("en-IN"),"Listings"],[liveStats.agents.toLocaleString("en-IN"),"Agents"],[String(liveStats.cities),"Cities"]].map(([v,l])=>(
              <div key={l} className="hero-stat" style={{background:"rgba(255,255,255,0.04)", backdropFilter:"blur(12px)", WebkitBackdropFilter:"blur(12px)", border:"1px solid rgba(43,168,224,0.12)", borderRadius:12, flex:"0 0 auto"}}>
                <div className="stat-value" style={{fontFamily:"'Cal Sans',Georgia,serif", fontSize:19, fontWeight:600, background:"linear-gradient(135deg, #FFFFFF 0%, #2BA8E0 100%)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent"}}>{v}</div>
            ...
            <div className="hero-search-row" style={{display:"flex", gap:0, alignItems:"stretch", padding:"12px 12px 12px 4px"}}>
                  ...
                  <div style={{position:"absolute", top:"calc(100% + 8px)", left:0, minWidth:180, background:"#0B0D10", border:"1px solid rgba(43,168,224,0.22)", borderRadius:14, boxShadow:"0 24px 64px rgba(0,0,0,0.7), 0 0 0 1px rgba(43,168,224,0.10)", zIndex:9999, overflowY:"auto", overflowX:"hidden", maxHeight:320, padding:"6px"}}>
                    {["", ...CITIES].map((c,i)=>(
                      <button key={i} type="button"
                        ...
                        style={{width:"100%", padding:"9px 14px", minHeight:44, boxSizing:"border-box", background: searchCity===c ? "rgba(43,168,224,0.12)" : "transparent", border:"none", borderRadius:9, textAlign:"left", fontFamily:"'DM Sans',sans-serif", fontSize:13, color: c ? "#fff" : "rgba(255,255,255,0.35)", cursor:"pointer", transition:"background 0.15s", display:"flex", alignItems:"center"}}
              ...
              <div style={{flex:1, display:"flex", alignItems:"center", padding:"0 16px", gap:10}}>
                ...
                <input value={searchQuery} onChange={e=>setSearchQuery(e.target.value)}
                  ...
                  style={{flex:1, height:"100%", minHeight:44, background:"transparent", border:"none", color:"#fff", fontSize:14, outline:"none", fontFamily:"'DM Sans',sans-serif"}}
                  onKeyDown={e => {
                    if (e.key === 'Enter') {
      ...
      <section
        ...
        style={{ background: "#0B0D10", padding: "96px 0 96px 56px" }}
      >
        <div style={{ maxWidth: 1280 + 56, paddingRight: 0, margin: "0 auto" }}>
          ...
          >
            {[
              ...
              <button
                key={c}
                onClick={() => setPropCity(c)}
                className={`city-tab${propCity === c ? " active" : ""}`}
              >
                {c}
              </button>
            ))}
            ...
            >
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                {CITIES.slice(0, 6).map((c) => (
                  <button
                    key={c}
                    onClick={() => setCatCity(c)}
                    className={`city-tab${catCity === c ? " active" : ""}`}
                    style={{ fontSize: 12 }}
                  >
                    {c}
                  </button>
            ...
            {CATEGORY_TILES.map((cat,i)=>{
              ...
              <a href={`/search?city=${catCity.toLowerCase().replace(" ","-")}&type=${cat.matchTypes[0]}`}
                ...
                <div style={{position:"relative", zIndex:2, padding:"0 28px 28px"}}>
                  <span style={{display:"inline-block", background:"rgba(43,168,224,0.15)", border:"1px solid rgba(43,168,224,0.30)", color:G.goldLt, borderRadius:8, padding:"4px 12px", fontSize:11, fontWeight:600, marginBottom:8}}>{count > 0 ? `${count} properties` : "Explore listings"}</span>
            ...
            >
              ...
              <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                {Object.keys(MARKET).map((c) => (
                  <button
                    key={c}
                    onClick={() => setInsightCity(c)}
                    className={`city-tab${insightCity === c ? " active" : ""}`}
                    style={{ fontSize: 12 }}
                  >
                    {c}
                  </button>
          ...
          >
            ...
            <Reveal delay={0.08}>
              ...
              >
                ...
                >
                  Current average across all property types in {insightCity}
                </div>
              </div>
            </Reveal>
                    ...
                    >
                      <span
                        style={{
                          ...
                          borderRadius: "50%",
                          background:
                            i === 0 ? G.gold : "rgba(43,168,224,0.10)",
            ...
            <Reveal delay={0.24}>
              ...
              >
                ...
                <a
                  href={`/search?city=${insightCity.toLowerCase().replace(" ", "-")}&sort=newest`}
                  style={{
                    fontSize: 13,
                    color: G.gold,
                    fontWeight: 600,
      ...
      <section
        ...
        style={{
          background: "linear-gradient(180deg, #000000 0%, #0B0D10 100%)",
          padding: "clamp(48px, 8vw, 96px) clamp(16px, 4vw, 40px)",
          position: "relative",
        }}
      >
        <div
          style={{
            ...
            zIndex: 0,
            backgroundImage:
              "url('https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=800&q=30')",
            backgroundSize: "cover",
            opacity: 0.03,
            mixBlendMode: "overlay",
          }}
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "500+ certified professionals",
              },
              {
              ...
              },
              {
                ...
                title: "NRI Friendly",
                desc: "Seamless cross-border service",
              },
              {
              ...
              },
              {
                ...
                title: "24/7 Support",
                desc: "Dedicated assistance always",
              },
            ].map((c, i) => (
      ...
      <section
        ...
        style={{ background: "#000000", padding: "96px 0 96px 56px" }}
      >
        <div style={{ maxWidth: 1280 + 56, margin: "0 auto" }}>
          <Reveal>
            ...
            >
              ...
              <a
                href="/locations"
                style={{ fontSize: 14, color: G.gold, fontWeight: 600 }}
              >
                View all cities →
              </a>
            </div>
          ...
          <div
            className="hide-scroll trending-carousel"
            style={{
              display: "flex",
              gap: 16,
              overflowX: "auto",
          ...
          >
            {LOCATIONS.map((loc, i) => (
              ...
              >
                <a
                  href={`/search?city=${loc.city.toLowerCase().replace(" ", "-")}&locality=${loc.area.toLowerCase().replace(" ", "-")}`}
                  className="loc-card"
                  style={{
                    position: "relative",
                    borderRadius: 20,
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(0,0,0,0.90) 0%, rgba(0,0,0,0.20) 60%, transparent 100%)",
                    }}
                  />
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div style={{ display: "flex", gap: 12, marginTop: 6 }}>
                      <span style={{ fontSize: 11, color: G.goldLt }}>
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(43,168,224,0.12) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(43,168,224,0.10) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            backgroundImage:
              "radial-gradient(ellipse 50% 80% at 80% 50%, rgba(43,168,224,0.1) 0%, transparent 60%)",
            pointerEvents: "none",
          }}
        />
        <Reveal
        ...
        >
          <div
            style={{
              ...
              boxShadow:
                "0 20px 60px rgba(0,0,0,0.45), 0 0 0 1px rgba(43,168,224,0.08)",
            }}
          >
            <h2
            ...
            >
              Ready to Find Your
              <br />
              <em style={{ fontStyle: "italic", color: G.goldLt }}>
                Perfect Property?
              </em>
            </h2>
            <p
            ...
            >
              Join buyers and investors who found their dream property
              through Nilay 360.
            </p>
            <div
            ...
            >
              <a
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.background = G.goldLt;
                  e.currentTarget.style.boxShadow =
                    "0 10px 30px rgba(61,190,245,0.45)";
                }}
                onMouseOut={(e) => {
                  e.currentTarget.style.background = G.gold;
                  e.currentTarget.style.boxShadow =
                    "0 10px 30px rgba(43,168,224,0.35)";
                }}
              >
                Browse Properties
              </a>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                India's premium real estate platform connecting discerning
                buyers with exceptional properties.
              </p>
              <div style={{ display: "flex", gap: 10 }}>
                {[
                  {
                    href: "https://www.instagram.com/nilay360",
          ...
          >
            ...
            <p style={{ fontSize: 12 }}>
              All listings subject to availability. Prices are indicative.
              Verify with RERA before purchase.
            </p>
          </div>
        </div>
      </footer>
