      ...
      <div style={{ maxWidth:420, margin:"0 auto" }}>
        <form action="/login" style={{ background:"#020C1C", borderRadius:16, padding:32, border:"1px solid rgba(0,0,0,0.06)" }}>
          ...
          <input type="email" required placeholder="you@example.com"
            style={{ width:"100%", padding:"13px 16px", borderRadius:8, border:"1px solid rgba(13,43,31,0.15)", fontSize:14, fontFamily:"'Cal Sans',sans-serif", marginBottom:18, outline:"none" }} />
          <button type="submit" style={{ width:"100%", padding:"13px", background:"#10C4C3", border:"none", borderRadius:8, color:"#020C1C", fontSize:14, fontWeight:700, cursor:"pointer", fontFamily:"'Cal Sans',sans-serif" }}>
            Send Reset Link
          </button>
