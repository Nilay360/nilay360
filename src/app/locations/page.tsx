...
const CITIES = [
  ...
  { slug: "bengaluru",  name: "Bengaluru",  state: "Karnataka",     img: "https://images.unsplash.com/photo-1596176530529-78163a4f7af2?w=800&q=80",   ppsf: 112000, growth: 11.5, tag: "Trending", tagColor: "#2BA8E0" },
        ...
        <section className="loc-pg-hero" style={{ paddingTop: "64px", background: "#000000", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "760px", margin: "0 auto", padding: "72px 48px 80px", textAlign: "center" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "5px 16px", background: "rgba(201,168,76,0.1)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "100px", marginBottom: "24px" }}>
              ...
              <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.2em", color: "#2BA8E0", textTransform: "uppercase" }}>India-Wide Coverage</span>
            </div>
            <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(40px, 6vw, 68px)", fontWeight: 300, color: "#000000", lineHeight: 1.1, marginBottom: "18px", animation: "fadeUp 0.5s ease-out both" }}>
              Explore Properties<br /><em style={{ fontStyle: "italic", color: "#2BA8E0" }}>Across India</em>
            </h1>
            ...
            <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap", animation: "fadeUp 0.5s 0.2s ease-out both" }}>
              {[`${totalListings}+ Listings`, "8 Cities", "50+ Neighbourhoods"].map(p => (
                <span key={p} style={{ padding: "7px 18px", background: "rgba(201,168,76,0.08)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "100px", fontSize: "12px", fontWeight: 600, color: "#2BA8E0", letterSpacing: "0.05em" }}>{p}</span>
              ))}
            </div>
          </div>
        </section>
        ...
        <section style={{ maxWidth: "1280px", margin: "0 auto", padding: "72px 48px" }}>
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "36px", flexWrap: "wrap", gap: "12px" }}>
            <div>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(30px, 3.8vw, 46px)", fontWeight: 400, color: "#000000" }}>
                Browse by City
              </h2>
            </div>
          ...
          <div className="loc-pg-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "22px" }}>
            {CITIES.map(city => {
              ...
              return (
                <a key={city.slug} href={`/locations/${city.slug}`} style={{ textDecoration: "none", display: "block", borderRadius: "18px", overflow: "hidden", border: hover ? "2px solid #2BA8E0" : "2px solid transparent", boxShadow: hover ? "0 20px 60px rgba(13,43,31,0.18)" : "0 2px 12px rgba(13,43,31,0.07)", transform: hover ? "translateY(-5px)" : "none", transition: "all 0.22s", background: "#fff" }}
                  ...
                  <div style={{ height: "180px", position: "relative", overflow: "hidden" }}>
                    ...
                    <div style={{ position: "absolute", bottom: "12px", left: "14px" }}>
                      <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "22px", fontWeight: 600, color: "#000000", lineHeight: 1.1 }}>{city.name}</h3>
                  ...
                  <div style={{ padding: "18px 18px 20px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "14px" }}>
                      <div>
                        ...
                        <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "17px", fontWeight: 600, color: "#000000" }}>{fmtINR(city.ppsf)}</p>
                      </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      ...
                      <span style={{ display: "inline-flex", alignItems: "center", gap: "5px", padding: "6px 14px", background: hover ? "#000000" : "#F8F6F1", borderRadius: "100px", fontSize: "11px", fontWeight: 700, color: hover ? "#2BA8E0" : "#000000", letterSpacing: "0.06em", transition: "all 0.18s" }}>
                        Explore
          ...
          <div style={{ maxWidth: "1280px", margin: "0 auto", padding: "0 48px 0" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
              <div>
                ...
                <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "30px", fontWeight: 400, color: "#000000" }}>Trending Neighbourhoods</h2>
              </div>
            ...
            {NEIGHBOURHOODS.map(n => {
              ...
              return (
                <a key={n.name} href={`/search?neighbourhood=${encodeURIComponent(n.name)}`} style={{ textDecoration: "none", flexShrink: 0 }}
                  onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}>
                  <div style={{ padding: "12px 20px", background: hover ? "#000000" : "#F8F6F1", border: `1.5px solid ${hover ? "transparent" : "rgba(13,43,31,0.08)"}`, borderRadius: "100px", display: "flex", alignItems: "center", gap: "8px", transition: "all 0.18s" }}>
                    <span style={{ fontSize: "13px", fontWeight: 600, color: hover ? "#000000" : "#000000", whiteSpace: "nowrap" }}>{n.name}</span>
                    <span style={{ fontSize: "11px", fontWeight: 600, color: hover ? "#2BA8E0" : "#9CA3AF" }}>{n.count}</span>
        ...
        <section className="loc-pg-market" style={{ background: "#000000", padding: "72px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ maxWidth: "1000px", margin: "0 auto", position: "relative", zIndex: 2 }}>
            <div style={{ textAlign: "center", marginBottom: "48px" }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(28px, 3.5vw, 44px)", fontWeight: 300, color: "#000000" }}>
                India Premium Real Estate<br /><em style={{ fontStyle: "italic", color: "#2BA8E0" }}>Overview · Q2 2025</em>
              </h2>
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
              {[
                ...
                <div key={s.label} style={{ background: "rgba(245,242,236,0.04)", border: "1px solid rgba(245,242,236,0.07)", borderRadius: "16px", padding: "32px 28px", textAlign: "center" }}>
                  ...
                  <p style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "42px", fontWeight: 600, color: "#2BA8E0", lineHeight: 1, marginBottom: "8px" }}>{s.value}</p>
                  <p style={{ fontSize: "14px", fontWeight: 600, color: "#000000", marginBottom: "3px" }}>{s.label}</p>
        ...
        <section className="loc-pg-cta" style={{ background: "#000000", padding: "80px 48px", textAlign: "center" }}>
          <div style={{ maxWidth: "560px", margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
              <a href="/contact" style={{ padding: "13px 32px", background: "#2BA8E0", borderRadius: "9px", color: "#000000", fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none" }}>Register Interest</a>
              <a href="/search"  style={{ padding: "13px 32px", background: "transparent", border: "1.5px solid rgba(13,43,31,0.18)", borderRadius: "9px", color: "#000000", fontSize: "13px", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase", textDecoration: "none" }}>Browse All Properties</a>
            </div>
          </div>
        </section>
