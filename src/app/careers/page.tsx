  ...
  return (
    ...
    >
      <div style={{ textAlign:"center", maxWidth:640, margin:"0 auto 8px" }}>
        <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif", fontSize:32, fontWeight:700, color:"#000000", marginBottom:12 }}>Open Roles</h2>
        <p style={{ fontSize:15, color:"#666", lineHeight:1.7 }}>
          ...
          Email your CV to <a href="mailto:careers@nilay360.com" style={{ color:"#2BA8E0", fontWeight:600 }}>careers@nilay360.com</a> and we'll reach out when a role fits.
        </p>
      </div>
    </PageShell>
  );
