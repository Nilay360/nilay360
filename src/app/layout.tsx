...
export const metadata: Metadata = {
  ...
  description:
    "Nilay 360 is a technology-powered real estate platform offering property discovery, virtual tours, and end-to-end transaction support across India.",
  keywords: [
    "real estate India",
    "property search",
  ...
  openGraph: {
    ...
    description:
      "Technology-powered real estate platform for property discovery, virtual tours, and transactions across India.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Nilay 360 — Real Estate Platform",
      },
    ],
  },
  twitter: {
  ...
  icons: {
    icon: "/nilay_logo_final.png",
    apple: "/nilay_logo_final.png",
  },
  appleWebApp: {
    capable: true,
