...
const FONTS =
  "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,600&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600&display=swap";
  ...
  return (
    <nav
      ...
      style={{
        ...
        borderBottom: "0.5px solid rgba(43,168,224,0.15)",
      }}
    >
  ...
  const cols = [
    ...
    },
    {
      ...
      links: [
        ...
        ["Investment Calc", "/investment-calculator"],
        ["Compare", "/compare"],
        ["Search", "/search"],
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.75, maxWidth: 240 }}>
        ...
        >
          ...
          <p style={{ fontSize: 12 }}>
            All listings subject to availability. Verify with RERA before
            purchase.
          </p>
        </div>
      </div>
...
export function PageShell({
  ...
  return (
    <>
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            background: `radial-gradient(ellipse 70% 60% at 70% 30%, rgba(43,168,224,0.06) 0%, transparent 65%), radial-gradient(ellipse 50% 70% at 25% 70%, rgba(43,168,224,0.03) 0%, transparent 60%)`,
          }}
        />
          ...
          {badge && (
            <div
              style={{
                ...
                border: "0.5px solid rgba(43,168,224,0.3)",
                borderRadius: 99,
                padding: "6px 16px",
                marginBottom: 22,
              }}
      ...
      <section
        className="sc-body"
        style={{ background: "#000000", padding: "56px" }}
      >
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          {children}
          {bullets && (
          ...
          <div
            className="sc-cta-banner"
            style={{
              marginTop: 48,
              padding: "36px 40px",
              background: "linear-gradient(135deg, #0B0D10 0%, #121519 100%)",
              borderRadius: 16,
              display: "flex",
              justifyContent: "space-between",
              alignItems: "center",
          ...
          >
            <div>
              ...
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.6)" }}>
                Browse live listings or talk to a Nilay 360 property expert.
              </p>
            </div>
