  ...
  return (
    ...
    >
      <div style={{ textAlign:"center", maxWidth:600, margin:"0 auto 8px" }}>
        <h2 style={{ fontFamily:"var(--font-heading-new)", fontSize:32, fontWeight:700, color:"#FFFFFF", marginBottom:14 }}>No saved properties yet</h2>
        ...
        <div style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap" }}>
          ...
          <a href="/properties" style={{ padding:"13px 30px", border:"1px solid rgba(13,43,31,0.2)", borderRadius:8, color:"#FFFFFF", fontSize:14, fontWeight:500 }}>Browse Properties</a>
        </div>
      </div>
    </PageShell>
  );
