...
function CheckItem({ label, comingSoon }: { label: string; comingSoon?: boolean }) {
  return (
    <div style={{ display: "flex", alignItems: "flex-start", gap: "10px", padding: "10px 0" }}>
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10C4C3" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0, marginTop: "2px" }}><polyline points="20 6 9 17 4 12" /></svg>
      <span style={{ fontSize: "14px", color: "#A9B4C2", lineHeight: 1.5 }}>
        {label}
        {comingSoon && (
      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "72px 24px 96px" }}>
        ...
        <div className="pricing-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
          ...
          <Card>
            ...
            <a
              href="/properties"
              style={{ display: "block", textAlign: "center", padding: "12px", borderRadius: "9px", fontSize: "12px", fontWeight: 700, letterSpacing: "0.04em", color: "#FFFFFF", border: "1.5px solid rgba(255,255,255,0.15)", background: "transparent", textDecoration: "none" }}
            >
              Browse Properties
            </a>
          </Card>
          ...
          {/* Premium tier */}
          <Card style={{ border: "1.5px solid rgba(16,196,195,0.4)", boxShadow: "0 4px 32px rgba(16,196,195,0.12)" }}>
            <div style={{ marginBottom: "24px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
                <span style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#10C4C3" }}>Premium</span>
                <span style={{ padding: "2px 8px", borderRadius: "100px", fontSize: "9px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", background: "rgba(16,196,195,0.15)", color: "#10C4C3", border: "1px solid rgba(16,196,195,0.3)" }}>
                  Best Value
                </span>
              </div>
            ...
            <a
              ...
              style={{ display: "block", textAlign: "center", padding: "12px", borderRadius: "9px", fontSize: "12px", fontWeight: 700, letterSpacing: "0.04em", color: "#020C1C", background: "#10C4C3", border: "none", textDecoration: "none" }}
            >
              Request Upgrade
            </a>
          </Card>
