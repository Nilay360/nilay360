...
function StatItem({ target, suffix, prefix, label, inView }: { target: number; suffix?: string; prefix?: string; label: string; inView: boolean }) {
  ...
  return (
    <div style={{ textAlign: "center", flex: "1 1 0", padding: "0 16px" }}>
      <div style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(40px, 5vw, 60px)", fontWeight: 600, color: "#10C4C3", lineHeight: 1, marginBottom: "8px" }}>
...
export default function AboutPage() {
  ...
  const TEAM = [
    { initials: "VK", name: "Vanith K", role: "Founder & CEO", bio: "A serial entrepreneur with 12+ years in Indian real estate, Vanith founded Nilay 360 to bring transparency and trust to premium property transactions across India.", color: "#10C4C3" },
  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#020C1C" }}>
        ...
        {/* ── 1. HERO ─────────────────────────────────────────── */}
        <section style={{ paddingTop: "64px", background: "#020C1C", minHeight: "520px", display: "flex", alignItems: "center", position: "relative", overflow: "hidden" }}>
          {/* Grid pattern */}
          ...
          <div className="ab-hero" style={{ position: "relative", zIndex: 2, maxWidth: "900px", margin: "0 auto", padding: "80px 48px 90px", textAlign: "center" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "5px 16px", background: "rgba(201,168,76,0.1)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "100px", marginBottom: "28px" }}>
              <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: "#10C4C3", boxShadow: "0 0 6px rgba(201,168,76,0.6)" }} />
              <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.2em", color: "#10C4C3", textTransform: "uppercase" }}>About Nilay 360</span>
            </div>
            <h1 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(36px, 5.5vw, 66px)", fontWeight: 300, color: "#020C1C", lineHeight: 1.12, marginBottom: "18px", animation: "fadeUp 0.6s ease-out both" }}>
              India's Most Trusted<br />Premium Real Estate Platform
            </h1>
            <p style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(20px, 2.5vw, 28px)", fontStyle: "italic", fontWeight: 400, color: "#10C4C3", marginBottom: "22px", animation: "fadeUp 0.6s 0.1s ease-out both" }}>
            ...
            <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", animation: "fadeUp 0.6s 0.3s ease-out both" }}>
              {["Est. 2024", "Hyderabad, India"].map(pill => (
                <span key={pill} style={{ padding: "8px 20px", background: "rgba(201,168,76,0.1)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "100px", fontSize: "12px", fontWeight: 600, color: "#10C4C3", letterSpacing: "0.08em" }}>{pill}</span>
              ))}
            </div>
          </div>
        </section>
        ...
        {/* ── 2. COMPANY STORY ────────────────────────────────── */}
        <section className="ab-story" style={{ background: "#020C1C", padding: "100px 48px" }}>
          <div className="ab-story-grid" style={{ maxWidth: "1200px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
            ...
            <div>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "18px" }}>
                <div style={{ width: "32px", height: "1.5px", background: "#10C4C3" }} />
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>Our Story</span>
              </div>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(34px, 4vw, 52px)", fontWeight: 400, color: "#020C1C", lineHeight: 1.15, marginBottom: "28px" }}>
                Born From a<br /><em style={{ fontStyle: "italic", color: "#10C4C3" }}>Simple Belief</em>
              </h2>
              ...
              <div style={{ borderLeft: "2px solid rgba(201,168,76,0.3)", paddingLeft: "24px", display: "flex", flexDirection: "column", gap: "0" }}>
                {TIMELINE.map((t, i) => (
                  <div key={i} style={{ position: "relative", paddingBottom: i < TIMELINE.length - 1 ? "24px" : "0" }}>
                    <div style={{ position: "absolute", left: "-32px", top: "4px", width: "12px", height: "12px", borderRadius: "50%", background: "#10C4C3", border: "2.5px solid #020C1C", boxShadow: "0 0 0 2px rgba(201,168,76,0.3)" }} />
                    <div style={{ display: "flex", gap: "12px", alignItems: "flex-start" }}>
                      <span style={{ fontSize: "11px", fontWeight: 700, color: "#10C4C3", letterSpacing: "0.05em", whiteSpace: "nowrap", marginTop: "2px", minWidth: "36px" }}>{t.year}</span>
                      <div>
                        <div style={{ fontSize: "14px", fontWeight: 600, color: "#020C1C", marginBottom: "2px" }}>{t.label}</div>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ borderRadius: "20px", overflow: "hidden", aspectRatio: "4/5", position: "relative", boxShadow: "0 32px 80px rgba(13,43,31,0.18)" }}>
                ...
                <div style={{ position: "absolute", bottom: "28px", left: "28px", right: "28px" }}>
                  <div style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "22px", fontWeight: 500, color: "#020C1C", lineHeight: 1.3 }}>
              ...
              {/* Floating badge */}
              <div style={{ position: "absolute", top: "28px", right: "-20px", background: "#10C4C3", borderRadius: "14px", padding: "18px 22px", textAlign: "center", boxShadow: "0 12px 40px rgba(201,168,76,0.35)" }}>
                <div style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "36px", fontWeight: 600, color: "#020C1C", lineHeight: 1 }}>14</div>
                <div style={{ fontSize: "10px", fontWeight: 700, color: "#020C1C", letterSpacing: "0.08em", textTransform: "uppercase", marginTop: "4px" }}>Cities</div>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* ── 3. MISSION & VISION ─────────────────────────────── */}
        <section className="ab-mission" style={{ background: "#020C1C", padding: "100px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "1100px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "56px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                ...
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>Purpose & Direction</span>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
              </div>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(32px, 4vw, 50px)", fontWeight: 300, color: "#020C1C", lineHeight: 1.15 }}>
                Why We Exist
              </h2>
            </div>
            <div className="ab-mission-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "24px" }}>
              {[
                ...
                <div key={card.label} style={{ background: "rgba(245,242,236,0.04)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "20px", padding: "44px 40px" }}>
                  ...
                  <h3 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "28px", fontWeight: 500, color: "#020C1C", marginBottom: "18px", lineHeight: 1.2 }}>{card.sub}</h3>
        ...
        <section className="ab-why" style={{ background: "#020C1C", padding: "100px 48px" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "60px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>The Nilay 360 Difference</span>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
              </div>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(32px, 4vw, 50px)", fontWeight: 400, color: "#020C1C", lineHeight: 1.15 }}>
                Why Discerning Buyers<br /><em style={{ fontStyle: "italic", color: "#10C4C3" }}>Choose Nilay 360</em>
              </h2>
            </div>
              ...
              {FEATURES.map((f, i) => {
                ...
                return (
                  <div key={i}
                    ...
                    style={{ background: hover ? "#020C1C" : "#fff", border: "1px solid rgba(13,43,31,0.08)", borderRadius: "16px", padding: "34px 30px", transition: "all 0.25s", cursor: "default", boxShadow: hover ? "0 24px 60px rgba(13,43,31,0.18)" : "0 1px 6px rgba(13,43,31,0.04)", transform: hover ? "translateY(-4px)" : "translateY(0)" }}>
                    ...
                    <h3 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "20px", fontWeight: 600, color: hover ? "#020C1C" : "#020C1C", marginBottom: "10px", transition: "color 0.25s" }}>{f.title}</h3>
        ...
        {/* ── 5. STATS ────────────────────────────────────────── */}
        <section className="ab-stats" style={{ background: "#020C1C", padding: "90px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <div ref={statsRef} style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "60px" }}>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(30px, 3.5vw, 46px)", fontWeight: 300, color: "#020C1C" }}>
                The Numbers Behind<br /><em style={{ fontStyle: "italic", color: "#10C4C3" }}>Our Promise</em>
              </h2>
            </div>
        ...
        {/* ── 6. LEADERSHIP TEAM ──────────────────────────────── */}
        <section className="ab-team" style={{ background: "#020C1C", padding: "100px 48px" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "60px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>The People Behind Nilay 360</span>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
              </div>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(32px, 4vw, 50px)", fontWeight: 400, color: "#020C1C", lineHeight: 1.15 }}>
                Leadership Team
              ...
              {TEAM.map((m, i) => {
                ...
                return (
                  <div key={i}
                    ...
                    <div style={{ width: "72px", height: "72px", borderRadius: "50%", background: `linear-gradient(135deg, ${m.color}22, ${m.color}44)`, border: `2px solid ${m.color}55`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Cal Sans', Georgia, serif", fontSize: "24px", fontWeight: 600, color: m.color, margin: "0 auto 18px", letterSpacing: "0.05em", transition: "all 0.25s", ...(hover ? { background: `linear-gradient(135deg, ${m.color}44, ${m.color}66)`, transform: "scale(1.06)" } : {}) }}>{m.initials}</div>
                    <h3 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "20px", fontWeight: 600, color: "#020C1C", marginBottom: "4px" }}>{m.name}</h3>
                    <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", color: "#10C4C3", textTransform: "uppercase", marginBottom: "14px" }}>{m.role}</p>
          ...
          <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "50px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "14px" }}>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>Recognition & Trust</span>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
              </div>
            ...
            <div className="ab-awards-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "18px" }}>
              {AWARDS.map((a, i) => (
                <div key={i} style={{ background: "#F8F6F1", border: "1px solid rgba(13,43,31,0.07)", borderRadius: "16px", padding: "32px 20px", textAlign: "center" }}>
                  ...
                  <h4 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "17px", fontWeight: 600, color: "#020C1C", marginBottom: "6px", lineHeight: 1.25 }}>{a.label}</h4>
        ...
        {/* ── 8. TESTIMONIALS ─────────────────────────────────── */}
        <section className="ab-testimonials" style={{ background: "#020C1C", padding: "100px 48px" }}>
          <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "56px" }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
                <span style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.22em", color: "#10C4C3", textTransform: "uppercase" }}>Client Stories</span>
                <div style={{ width: "28px", height: "1px", background: "rgba(201,168,76,0.5)" }} />
              </div>
              <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(30px, 3.8vw, 48px)", fontWeight: 400, color: "#020C1C" }}>
            ...
            {testimonials.length === 0 ? (
              <div style={{ background: "#fff", border: "1px solid rgba(13,43,31,0.07)", borderRadius: "18px", padding: "56px 32px", textAlign: "center", maxWidth: "560px", margin: "0 auto" }}>
                <p style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "22px", color: "#020C1C", marginBottom: "8px" }}>Be the First to Share Your Story</p>
                ...
                {testimonials.map((t) => (
                  <div key={t.id} style={{ background: "#fff", border: "1px solid rgba(13,43,31,0.07)", borderRadius: "18px", padding: "36px 32px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "12px", paddingTop: "18px", borderTop: "1px solid rgba(13,43,31,0.06)" }}>
                      <div style={{ width: "38px", height: "38px", borderRadius: "50%", background: "linear-gradient(135deg, rgba(201,168,76,0.2), rgba(201,168,76,0.4))", border: "1.5px solid rgba(201,168,76,0.3)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: 700, color: "#10C4C3", flexShrink: 0 }}>{t.initials}</div>
                      <div>
                        <div style={{ fontSize: "13px", fontWeight: 600, color: "#020C1C" }}>{t.name}</div>
        ...
        {/* ── 9. CTA ──────────────────────────────────────────── */}
        <section className="ab-cta" style={{ background: "#020C1C", padding: "90px 48px", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 2, maxWidth: "680px", margin: "0 auto", textAlign: "center" }}>
            <h2 style={{ fontFamily: "'Cal Sans', Georgia, serif", fontSize: "clamp(34px, 5vw, 58px)", fontWeight: 300, color: "#020C1C", lineHeight: 1.15, marginBottom: "16px" }}>
              Join Thousands of<br /><em style={{ fontStyle: "italic", color: "#10C4C3" }}>Satisfied Clients</em>
            </h2>
            ...
            <div style={{ display: "flex", gap: "14px", justifyContent: "center", flexWrap: "wrap" }}>
              <a href="/properties" style={{ padding: "14px 36px", background: "#10C4C3", border: "none", borderRadius: "9px", color: "#020C1C", fontSize: "13px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: "8px" }}>
                Browse Properties
              ...
              <div>
                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  {[
                    ...
                    href ? (
                      <a key={s} href={href} target="_blank" rel="noopener noreferrer" aria-label={s} style={{ width: "34px", height: "34px", borderRadius: "8px", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.07)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "10px", color: "rgba(255,255,255,0.35)", fontWeight: 700, textDecoration: "none", cursor: "pointer" }}>{s}</a>
                    ) : (
