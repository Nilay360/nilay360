...
const LOOKING_AHEAD = "Today, Nilay360 begins its journey in Hyderabad. Tomorrow, the vision extends across India. In the years ahead, the goal is to build one of the world's leading PropTech ecosystems under NIVILA Group, delivering intelligent, immersive, customer-first solutions that redefine how people experience real estate. This is only the beginning.";
  ...
  return (
    <section id="ch11" style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", gap: "clamp(26px, 3.2vw, 44px)", padding: "20vh clamp(20px, 6vw, 80px) 12vh", overflow: "clip", background: "linear-gradient(180deg, rgba(2,12,28,0) 0%, #010203 42%, #010203 100%)" }}>
      ...
      <div style={{ position: "relative", maxWidth: "680px" }}>
        ...
        <Reveal>
          <p style={{ margin: 0, fontFamily: "var(--font-heading-new)", fontWeight: 300, fontSize: "clamp(17px, 1.5vw, 22px)", lineHeight: 1.7, color: "rgba(255,255,255,0.7)", textWrap: "balance" }}>{LOOKING_AHEAD}</p>
        </Reveal>
      </div>
      ...
      <div style={{ position: "relative", display: "flex", flexDirection: "column", alignItems: "center", gap: "clamp(6px, 1vw, 14px)", marginTop: "clamp(24px, 4vh, 48px)" }}>
        <Reveal>
          <h2 style={{ margin: 0, fontFamily: "var(--font-heading-new)", fontWeight: 200, fontSize: "clamp(34px, 7vw, 112px)", lineHeight: 1.0, letterSpacing: "0.02em", color: "#FFFFFF" }}>VIEW FIRST.</h2>
        </Reveal>
        <Reveal delay={0.5}>
          <h2 style={{ margin: 0, fontFamily: "var(--font-heading-new)", fontWeight: 200, fontSize: "clamp(34px, 7vw, 112px)", lineHeight: 1.0, letterSpacing: "0.02em", color: "#FFFFFF" }}>HOME NEXT.</h2>
        </Reveal>
      </div>
      ...
      <Reveal delay={1.1}>
        <p style={{ position: "relative", margin: 0, fontFamily: "var(--font-support-new)", fontSize: "clamp(9.5px, 0.85vw, 11px)", fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: "rgba(255,255,255,0.42)" }}>A Flagship PropTech Platform by NIVILA Group</p>
      </Reveal>
      <Reveal delay={1.3}>
        <p style={{ position: "relative", margin: 0, fontFamily: "var(--font-heading-new)", fontWeight: 300, fontSize: "clamp(18px, 2vw, 30px)", letterSpacing: "-0.01em", color: TEAL }}>Building Trust Through Technology.</p>
      </Reveal>
      ...
      */}
      <Reveal delay={1.6}>
        <div style={{ position: "relative", display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "14px", marginTop: "clamp(20px, 3vw, 40px)" }}>
          <a href="/properties" style={{ display: "inline-flex", alignItems: "center", gap: "12px", padding: "17px 34px", border: "1px solid transparent", borderRadius: "999px", background: TEAL, fontFamily: "var(--font-support-new)", fontSize: "11px", fontWeight: 700, letterSpacing: "0.22em", textTransform: "uppercase", color: "#020C1C", textDecoration: "none" }}>Explore Properties</a>
          <a href="/contact" style={{ display: "inline-flex", alignItems: "center", gap: "12px", padding: "17px 34px", border: "1px solid rgba(255,255,255,0.18)", borderRadius: "999px", background: "rgba(255,255,255,0.03)", backdropFilter: "blur(14px)", fontFamily: "var(--font-support-new)", fontSize: "11px", fontWeight: 600, letterSpacing: "0.22em", textTransform: "uppercase", color: "#FFFFFF", textDecoration: "none" }}>Contact Us</a>
        </div>
      </Reveal>
    </section>
  );
