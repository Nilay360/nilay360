...
const VALUES = [
  { n: "01", title: "Trust", desc: "Verified information, always. Nothing shown that we would not stand behind." },
  ...
  return (
    <section id="ch10" style={{ position: "relative", padding: "16vh clamp(20px, 6vw, 80px) 18vh", overflow: "clip" }}>
      <div style={{ width: "100%", maxWidth: "1240px", margin: "0 auto" }}>
        ...
        <Reveal>
          <h2 style={{ margin: "0 0 clamp(48px, 6vw, 88px)", maxWidth: "20ch", fontFamily: "'Cal Sans', Georgia, serif", fontWeight: 300, fontSize: "clamp(30px, 4.4vw, 72px)", lineHeight: 1.06, letterSpacing: "-0.026em", color: "#FFFFFF" }}>Five commitments we do not negotiate.</h2>
        </Reveal>
          ...
          {VALUES.map((v, i) => {
            ...
            return (
              <Reveal key={v.n} delay={i * 0.08} y={26}>
                ...
                >
                  <span style={{ display: "block", fontFamily: "'Cal Sans', sans-serif", fontSize: "10px", fontWeight: 600, letterSpacing: "0.24em", color: last ? TEAL : "rgba(16,196,195,0.75)" }}>{v.n}</span>
                  <h3 style={{ margin: "clamp(34px, 4vw, 54px) 0 0", fontFamily: "'Cal Sans', Georgia, serif", fontWeight: 300, fontSize: "clamp(21px, 2vw, 30px)", letterSpacing: "-0.012em", color: "#FFFFFF" }}>{v.title}</h3>
        ...
        <Reveal delay={0.2} y={20}>
          <div style={{ maxWidth: "760px", margin: "0 auto", textAlign: "center", paddingTop: "clamp(40px, 5vw, 64px)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
            <span style={{ display: "block", marginBottom: "18px", fontFamily: "'Cal Sans', sans-serif", fontSize: "10px", fontWeight: 600, letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(255,255,255,0.34)" }}>Our Promise</span>
            <p style={{ margin: 0, fontFamily: "'Cal Sans', Georgia, serif", fontWeight: 300, fontSize: "clamp(19px, 2.1vw, 30px)", lineHeight: 1.5, letterSpacing: "-0.012em", color: "rgba(255,255,255,0.92)", textWrap: "balance" }}>{PROMISE}</p>
          </div>
        </Reveal>
      </div>
    </section>
