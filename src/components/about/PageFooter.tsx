...
export default function PageFooter() {
  return (
    <footer style={{ position: "relative", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "center", gap: "16px", padding: "30px clamp(20px, 6vw, 80px) 40px", background: "#010203", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
