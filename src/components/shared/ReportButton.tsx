...
const inputStyle: React.CSSProperties = {
  ...
  color: "#020C1C", fontFamily: "var(--font-body-new)", outline: "none",
};
...
export default function ReportButton({
  ...
  const triggerStyle: React.CSSProperties = variant === "dark"
    ? { display: "flex", alignItems: "center", gap: "7px", padding: "8px 16px", borderRadius: "999px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.10)", color: "#fff", fontSize: "12px", fontWeight: 500, cursor: "pointer", fontFamily: "var(--font-body-new)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" }
    : { display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", padding: "12px", background: "#fff", border: "1.5px solid rgba(13,43,31,0.1)", borderRadius: "10px", fontSize: "12px", fontWeight: 600, color: "#6B7C72", cursor: "pointer", fontFamily: "var(--font-body-new)", width: "100%" };
      ...
      {open && (
        ...
        >
          <div
            ...
            style={{ background: "#fff", borderRadius: "18px", border: "1px solid rgba(13,43,31,0.07)", boxShadow: "0 12px 48px rgba(0,0,0,0.25)", width: "100%", maxWidth: "420px", padding: "26px 28px", fontFamily: "var(--font-body-new)" }}
          >
            {submitted ? (
              <div style={{ textAlign: "center", padding: "12px 0" }}>
                <div style={{ fontSize: "36px", marginBottom: "10px" }}>✅</div>
                <p style={{ fontFamily: "var(--font-heading-new)", fontSize: "20px", color: "#020C1C", marginBottom: "8px" }}>Report submitted</p>
                ...
                <button onClick={close} style={{ padding: "10px 20px", background: "#10C4C3", border: "none", borderRadius: "8px", color: "#020C1C", fontSize: "12px", fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-body-new)" }}>Close</button>
              </div>
            ) : (
              <>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "18px" }}>
                  <h3 style={{ fontFamily: "var(--font-heading-new)", fontSize: "22px", fontWeight: 600, color: "#020C1C" }}>Report {entityType === "listing" ? "Listing" : "Profile"}</h3>
