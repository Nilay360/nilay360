    ...
    <div className={cn("w-full max-w-[860px] mx-auto", className)}>
        ...
        {TABS.map(tab => (
          <button
            ...
            className={cn(
              ...
              activeTab === tab
                ? "bg-white text-[#000000] font-semibold border-[rgba(27,67,50,0.15)]"
                : "bg-[rgba(0,0,0,0.5)] text-white/60 hover:text-white border-transparent"
            )}
          >
            {tab}
            {tab === "New Projects" && (
              <span className="absolute -top-2 -right-1 text-[8px] bg-[#2BA8E0] text-[#000000] font-bold px-1.5 py-0.5 rounded-full">
                NEW
              </span>
            )}
          </button>
      ...
      <div className="bg-white rounded-[0_8px_8px_8px] flex items-stretch border border-[rgba(27,67,50,0.15)] overflow-hidden shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
        ...
        <div className="flex-1 min-w-[120px] border-r border-[rgba(27,67,50,0.1)]">
          <div className="px-4 py-3">
            ...
            <select
              ...
              className="w-full text-[13px] font-medium text-[#000000] bg-transparent border-none outline-none cursor-pointer"
            >
        ...
        <button
          ...
          className="px-7 bg-[#2BA8E0] hover:bg-[#1577B8] text-[#000000] font-semibold text-[14px] transition-colors duration-150 flex items-center gap-2 shrink-0"
        >
